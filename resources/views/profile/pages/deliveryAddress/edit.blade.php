                        ...
                        <form action="{{route('profile.delivery.update')}}" method="post">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <div class="mb-3">
                                        <label for="client_phone_number" class="form-label">Номер телефону(Приклад: +380981234123 )</label>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <a href="{{route('profile.delivery.get')}}" class="btn btn-danger">Відмінити</a>
                                    </div>
                                </div>
                            </div>
                        </form>
